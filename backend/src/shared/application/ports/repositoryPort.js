...
export const BASE_REPOSITORY_METHODS = Object.freeze([
  "findById",
]);

export const COLLECTION_REPOSITORY_METHODS = Object.freeze([
  "findAll",
]);

export const WRITABLE_REPOSITORY_METHODS = Object.freeze([
  "create",
  "updateById",
  "deleteById",
]);
