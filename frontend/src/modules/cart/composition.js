...
import { CartEvents } from "./domain/events/CartEvents.js";
import { assertInputPort } from "../../shared/kernel/assertions/portAssertions.js";

const CART_INPUT_PORT_METHODS = ["addToCart","removeFromCart","setQuantity","clearCart","getCart"];
...
export function createCartModule({ cart: repo, sessionStore, eventBus, notify }) {
  ...
  assertInputPort("CartInputPort", inputPort, CART_INPUT_PORT_METHODS);
  return inputPort;
}
