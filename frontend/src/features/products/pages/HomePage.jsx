        ...
        <div className="hero-inner">
          <div className="hero-content">
            <div className="hero-eyebrow">
              <FiCpu size={14} /> New arrivals every week
            </div>
            <h1 className="hero-title">
              Premium tech, picked with <em>precision</em>
            </h1>
            <p className="hero-sub">
              Shop phones, accessories, and everyday devices in a faster storefront built around
              clear product discovery, confident comparison, and secure checkout.
            </p>
            <div className="hero-actions">
              <button className="btn btn-primary btn-lg" onClick={() => navigate("/products")}>
                Shop now <FiArrowRight />
              </button>
              <button className="btn btn-lg muted-cta" onClick={() => navigate("/about")}>
                About us
              </button>
            </div>
          ...
          <div className="hero-visual">
              ...
              <div className="hero-product-card">
                ...
                <div className="hero-product-info">
                  ...
                  <div className="hero-product-price">
                    {heroProduct.price.currency} {heroProduct.price.amount.toFixed(2)}
                  </div>
                </div>
              </div>
            )}
            <div className="hero-card wide">
              ...
              <div>
                <div className="hero-card-title">{products.length} products</div>
                <div className="hero-card-sub">Across all categories</div>
              </div>
            </div>
            <div className="hero-card">
              ...
              <div className="hero-card-title">{shopCategories.length} categories</div>
              <div className="hero-card-sub">Something for everyone</div>
            </div>
            <div className="hero-card">
              <span className="hero-card-icon">
                <FiTruck size={22} />
              ...
              <div className="hero-card-sub">To your door</div>
            </div>
            <div className="hero-card">
              <span className="hero-card-icon">
                <FiShield size={22} />
              </span>
              <div className="hero-card-title">Secure checkout</div>
              <div className="hero-card-sub">Stripe-powered</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <div className="home-featured">
        <section className="discovery-grid">
            ...
            <div className="discovery-head">
              <div>
                ...
                <p className="page-subtitle">
                  Cleaner paths into phones, accessories, and ready-to-ship essentials.
                </p>
              </div>
          ...
          <div className="discovery-stack">
            {heroProduct && (
              <button
                className="discovery-panel spotlight-card"
              ...
              >
                ...
                <div className="spotlight-card-body">
                  <div className="spotlight-copy">
                    ...
                    <p>
                      {heroProduct.category || "Featured product"} ready for a faster path to
                      purchase.
                    </p>
        ...
        <div className="home-featured-head">
          <div>
            ...
            <p className="page-subtitle">
              A tighter product shelf with clearer entry points and less visual noise.
            </p>
          </div>
          {filtered.length > 0 && (
            <button className="btn btn-ghost" onClick={() => navigate("/products")}>
        ...
        <div className="category-strip mb-7">
          <button
            className={`category-pill ${selectedCat === "all" ? "active" : ""}`}
          ...
          {shopCategories.map((c) => (
            <button
              key={c.id}
              className={`category-pill ${selectedCat === c.name ? "active" : ""}`}
            ...
            <div className="launch-strip-list">
              {newestProducts.map((product) => (
                ...
                >
                  ...
                  <span className="launch-chip-price">
        ...
        {filtered.length > 0 && (
          <div className="mt-10 text-center">
            <button className="btn btn-primary px-8 py-3" onClick={() => navigate("/products")}>
