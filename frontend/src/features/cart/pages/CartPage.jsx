    ...
    return (
      <div className="page-shell">
        <div className="empty-state pt-20">
          ...
          <button className="btn btn-primary mt-5" onClick={() => navigate("/products")}>
            ...
            <div key={item.id} className="cart-item">
              ...
              <div className="cart-item-main">
                ...
                <div className="text-[13px] text-ink-muted">
                  {item.price.currency} {item.price.amount.toFixed(2)} each
                </div>
                <QtyControl
                  value={item.quantity}
                  max={item.stock}
              ...
              <div className="cart-item-total">
                ...
                <button
                  className="btn btn-sm bg-transparent text-accent sm:mt-2"
        ...
        <div className="card order-summary">
          ...
          {cartItems.map((i) => (
            <div key={i.id} className="summary-row">
              <span className="min-w-0 max-w-[14rem] overflow-hidden text-ellipsis whitespace-nowrap">
                {i.name} ×{i.quantity}
              </span>
              <span>
          ...
          <button className="btn btn-ghost mt-2 w-full" onClick={() => navigate("/products")}>
            Continue shopping
          </button>
        </div>
      </div>
