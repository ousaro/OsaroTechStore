      ...
      <div className="content-area">
        <div className="page-header">
          <div>
            ...
            <p className="page-subtitle">
              {visibleOrders.length} orders{adminView ? " across customers" : ""}
            </p>
          </div>
        </div>
        ...
        {loadingOrders ? (
          ...
          <div className="empty-state">
            ...
            <h3>No orders yet</h3>
            <p>
              {adminView ? "Customer orders will appear here." : "Your orders will appear here."}
            </p>
          </div>
        ) : (
                    ...
                    <div className="order-card-body">
                      ...
                      <div className="order-card-footer">
                        ...
                        <div className="order-customer-info">
                          ...
                          {o.customerEmail && (
                            <p className="text-sm text-ink-muted">{o.customerEmail}</p>
                          )}
                        </div>
                        {user?.isAdmin ? (
                          <div className="order-admin-tools">
                            <label className="field">
                              ...
                              <Select
                                ...
                                onChange={(e) => setDraft(o.id, "orderStatus", e.target.value)}
                              >
                            ...
                            <label className="field">
                              ...
                              <Select
                                ...
                                onChange={(e) => setDraft(o.id, "paymentStatus", e.target.value)}
                              >
