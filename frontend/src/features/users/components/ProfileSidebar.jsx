...
import { FiArchive, FiGrid, FiHeart, FiKey, FiLayers, FiMapPin, FiShoppingBag, FiTag, FiTrash2, FiUsers, FiUser } from "react-icons/fi";
    ...
    <aside className="sidebar">
      ...
      {isAdmin && (
        <>
          ...
          <Link to="/dashboard"        className={`sidebar-link ${path==="/dashboard"?"active":""}`}><FiGrid size={16} /> Dashboard <span className="admin-tag ml-auto">Admin</span></Link>
          ...
          <Link to="/admin/products"   className={`sidebar-link ${path==="/admin/products"?"active":""}`}><FiLayers size={16} /> Add product <span className="admin-tag ml-auto">Admin</span></Link>
